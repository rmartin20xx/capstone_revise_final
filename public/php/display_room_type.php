...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/display_room_type.css">
</head>
<body>
<?php
...
function getRoomTypes()
{
    ...
    if ($result) {
        ...
        if ($result->num_rows > 0) {
            // Output table header
            echo "<table class='room-type-table'>
                    <tr>
                        <th>Room Type ID</th>
                        <th>Room Type</th>
                        <th>Description</th>
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<tr>
                        ...
                        <td><a href='edit_room_type.php?room_type_id=".$row['room_type_id']."' class='edit-link'>Edit</a></td>
                        <td><a href='delete_room_type.php?room_type_id=".$row['room_type_id']."' onclick='return confirm(\"Are you sure you want to delete this room type?\")' class='delete-link'>Delete</a></td>
                    </tr>";
            }
