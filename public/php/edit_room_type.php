...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/edit_room_type.css">
</head>
<body>
<?php
...
if (isset($_GET['room_type_id'])) {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        //     // Call the function to update the room type
            ...
            echo "Room type updated successfully.";
            header("Location: display_room_type.php");
            exit();
        // } else {
    ...
    if ($roomTypeDetails) {
        ...
        <form method="post" action="" enctype="multipart/form-data">
            ...
            <?php if ($image) : ?>
                <p>Current Image: <img src="../storage/img/<?php echo $image; ?>" alt="Current Image" class="current-image"></p>
                <p><?php echo $image; ?></p>
            <?php else : ?>
